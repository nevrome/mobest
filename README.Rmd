...
kernels <- par2try %>% purrr::pmap(function(...) {
  ...
  mobest::create_kernset(
    ac1 = create_kernel(row$ds, row$ds, row$dt, 0.065),
    ac2 = create_kernel(row$ds, row$ds, row$dt, 0.08)
  )
...
model_grid <- mobest::create_model_grid(
  ...
  kernel = mobest::create_kernset_multi(
    kernel_1 = mobest::create_kernset(
      ac1 = create_kernel(1000000, 1000000, 200, 0.1),
      ac2 = create_kernel(1000000, 1000000, 200, 0.1)
    ),
    kernel_2 = mobest::create_kernset(
      ac1 = create_kernel(1000000, 1000000, 200, 0.1),
      ac2 = create_kernel(1000000, 1000000, 250, 0.1)
    )
  ),
