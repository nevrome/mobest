...
For other applications the code would probably have to be changed significantly. This is not a general-purpose package, but rather a structured collection of functions for said paper.
